...
.post(cors.cors, (req, res, next) => {
    ...
    */
    var mailOptions = {
        ...
        subject: `Richiesta prenotazione Aula Blu`,
        html: `è stata inviata una nuova richiesta di prenotazione per l'aula blu. Verificare la disponibilità nel Database`
    };
