...
const emailRouter3 = express.Router();
...
.post(cors.cors, (req, res, next) => {
    ...
    */
    var mailOptions = {
        ...
        subject: `Prenotazione Aula Blu`,
        html: `Buongiorno, la sua prenotazione non è andata a buon fine. La data da lei richiesta, non è disponibile.`
    };
